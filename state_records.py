...
def state_records():
    ...
    marathon_button.bottomright = ((screen_width / 2 - 7) * dim, (top_margin + 5) * dim)
    ...
    sprint_button.midbottom = ((screen_width / 2) * dim, (top_margin + 5) * dim)
    ...
    blitz_button.bottomleft = ((screen_width / 2 + 7) * dim, (top_margin + 5) * dim)
    ...
    for r in range(len(top_n)):
        ...
        int_rect.midbottom = ((left_margin - 3) * dim, (top_margin + 7.5 + r * 1.5) * dim)
        ...
        for c in range(1, len(top_n[r])):
            ...
            stat_rect.bottomleft = ((left_margin - 5 + c * 5) * dim, (top_margin + 7.5 + r * 1.5) * dim)
