...
def state_login(current_time, screen, dim, border_width, state):
    ...
    for i in blocks:
        pygame.draw.rect(screen, shade, [(screen_width / 2 + i[0] - 2) * dim, (top_margin + 1 - i[1]) * dim, dim + border_width, dim + border_width])
        # pygame.draw.rect(screen, 'White', [(screen_width / 2 + i[0] - 2) * dim, (top_margin + 1 - i[1]) * dim, dim + border_width, dim + border_width], border_width)
    ...
    user_box.midbottom = ((screen_width / 2) * dim, (top_margin + 10) * dim)
    pygame.draw.rect(screen, 'White', user_box, border_width + 1)

    pass_box = pygame.Rect(0, 0, rect_width, rect_height)
    pass_box.midbottom = ((screen_width / 2) * dim, (top_margin + 15) * dim)
